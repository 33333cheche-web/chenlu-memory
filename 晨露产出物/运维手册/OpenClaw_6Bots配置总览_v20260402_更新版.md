...
- **更新时间：2026-04-02 14:13 (Asia/Shanghai)** - SUNNY/RAINBOW 切换为 Kimi 主模型；Baby 现行链路：Kimi 主，Moonshot 备 1，GPT 备 2
...
- 默认模型策略：
 - `primary`: `kimi-coding/kimi-for-coding`
 - `fallbacks`: `moonshot/kimi-k2.5`, `codex-newcli-com/gpt-5.3-codex`
...
- 运行备注：`codex-newcli-com/gpt-5.3-codex` 在 2026-04-01 实测"轻量直连可 200，但 OpenClaw 实际 fallback 可能出现 403 / timeout"，只保留为末位备用。
...
### 最新运行模型日志
- `2026-04-01T17:19:58.371+08:00 [gateway] agent model: kimi-coding/kimi-for-coding`
...
- 模型策略总览：
 ...
 - **BABY：Kimi 主，Moonshot 备 1，GPT 备 2**（2026-04-01 更新）
